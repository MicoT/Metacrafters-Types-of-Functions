...
exports.waitForDeployment = exports.getRemoteDeployment = exports.getPlatformClient = exports.disablePlatform = exports.enablePlatform = exports.getNetwork = exports.getAdminClient = exports.getPlatformApiKey = void 0;
...
const platform_deploy_client_1 = require("platform-deploy-client");
...
function getAdminClient(hre) {
    return new defender_admin_client_1.AdminClient(getPlatformApiKey(hre));
}
...
function disablePlatform(hre, platformModule, opts, unsupportedFunction) {
    if (opts.platform) {
        throw new upgrades_core_1.UpgradesError(`The function ${unsupportedFunction} is not supported with the \`platform\` option.`);
    }
        ...
        (0, debug_1.default)(`The function ${unsupportedFunction} is not supported with the \`platform.useDeploy\` configuration option. Using the Hardhat signer instead.`);
    }
}
