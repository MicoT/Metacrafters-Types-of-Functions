...
function getLicenseFromMetadata(contractInfo) {
    ...
    if (metadataString === undefined) {
        (0, debug_1.default)('Metadata not found in compiler output');
        return undefined;
    }
    const metadata = JSON.parse(metadataString);
    const license = metadata.sources[contractInfo.sourceName].license;
    if (license === undefined) {
        (0, debug_1.default)('License not found in metadata');
    }
    else {
        (0, debug_1.default)(`Found license from metadata: ${license}`);
    }
    return license;
}
